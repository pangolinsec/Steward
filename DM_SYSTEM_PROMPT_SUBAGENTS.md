...
## For Claude Code with Almanac MCP Server + Hybrid NPC Subagent System
...
2. **Current character state** — stats, HP, inventory, active effects (from `almanac_get_character`)
